...
function T:GetPlayerHeight()
	local _,_,_,_,_,_,height = AirjHack:GetCamera()
	return height
end
...
function T:New(frame,addon)
	...
	s.playerRaceHeight=raceHeights[gender][race] or raceHeights[2]["Human"]
...
function T:UpdatePlayerHeight()
	self.playerHeight = self:GetPlayerHeight()
